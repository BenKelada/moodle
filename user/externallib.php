                    ...
                    new external_single_structure(
                        array(
                            ...
                            'alternatename' =>
                                new external_value(PARAM_NOTAGS, 'The alternate name of the user', VALUE_OPTIONAL),
                            'userpicture' =>
                                new external_value(PARAM_INT, 'The draft area where the new user picture has been uploaded to, 0 to delete', VALUE_OPTIONAL),
                            'customfields' => new external_multiple_structure(
                                new external_single_structure(
                                    array(
                                        'type'  => new external_value(PARAM_ALPHANUMEXT, 'The name of the custom field'),
    ...
    public static function update_users($users) {
        ...
        foreach ($params['users'] as $user) {
            ...
            if (empty($CFG->disableuserimages) && isset($user['userpicture'])) {
                ...
                user_update_picture($userobject, $filemanageroptions);
            }
