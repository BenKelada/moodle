...
class core_ddl_testcase extends database_driver_testcase {
    ...
    public function test_create_table() {
        ...
        // Long table name names - the largest allowed by the configuration which includes the prefix to ensure it's created.
        $tablechars = str_repeat('a', xmldb_table::NAME_MAX_LENGTH - strlen($CFG->phpunit_prefix));
