...
class assign_submission_status implements renderable {
    ...
    public function __construct($allowsubmissionsfromdate,
        ...
        /* OUA CUSTOM: put feedback status renderable inside submission status renderable */
        $this->feedbackstatusrenderable = $feedbackstatusrenderable;
        /* END OUA CUSTOM */
    }
}
/**
