...
/* Begin OUA CUSTOM: Hyperlinked forum title in discussion to forum view */

$forumviewurl = new moodle_url('/mod/forum/view.php', array('id'=>$cm->id));
$forumurllink = '<a href="'.$forumviewurl->out().'">'.format_string($forum->name).'</a>';
echo $OUTPUT->heading($forumurllink, 2);

/* End OUA CUSTOM: Hyperlinked forum title in discussion to forum view */
